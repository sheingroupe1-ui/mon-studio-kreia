import type { VisualStyleAnalysis } from "./types";
...
export const VISUAL_STYLE_REGISTRY: VisualStylePreset[] = [
  {
    id: "cinematic-real",
    ...
    pace: "rythme de film",
    lockedStylePhrase:
      "cinéma réaliste, live-action, éclairage naturel cinématographique, textures photographiques, caméra fluide",
  },
  {
    id: "photoreal",
    label: "Photoréaliste",
    ...
    pace: "posé",
    lockedStylePhrase:
      "photoréaliste, haute définition, éclairage précis, textures de peau et de tissu ultra-détaillées",
  },
  {
    id: "cinematic-3d",
    ...
    pace: "cinématique",
    lockedStylePhrase:
      "3D cinématographique, éclairage studio, textures détaillées, caméra de film d'animation",
  },
  {
    id: "stylized-3d",
    label: "3D stylisée",
    ...
    pace: "dynamique",
    lockedStylePhrase:
      "3D stylisée, volumes graphiques, couleurs franches, éclairage contrasté",
  },
  {
    id: "pixar",
    ...
    pace: "vif et lisible",
    lockedStylePhrase:
      "animation 3D familiale, formes douces, éclairage chaleureux, expressions très lisibles",
  },
  {
    id: "anime",
    label: "Anime",
    ...
    pace: "découpé",
    lockedStylePhrase:
      "anime 2D, traits nets, cel-shading, éclairages dramatiques, fond cinématographique",
  },
  {
    id: "cartoon-2d",
    label: "Cartoon 2D",
    ...
    pace: "énergique",
    lockedStylePhrase:
      "cartoon 2D, contours nets, couleurs vives, éclairage plat, lecture immédiate",
  },
  {
    id: "noir-drama",
    ...
    pace: "retenu",
    lockedStylePhrase:
      "drame cinématographique, clair-obscur, palette sombre, grain film, tension visuelle",
  },
  {
    id: "source-faithful",
    ...
    lockedStylePhrase:
      "style visuel identique à la vidéo source, mêmes textures, même éclairage, même rendu",
  },
  {
    id: "custom",
    label: "Personnalisé",
...
export function visualStyleById(id: string | undefined): VisualStylePreset | undefined {
...
function emptyStyle(): VisualStyleAnalysis {
  return {
    renderType: "",
    artisticStyle: "",
    characterAppearance: "",
...
export function styleFromUserChoice(
  id: VisualStyleId | string | undefined,
  customText?: string,
): VisualStyleAnalysis {
  ...
  const phrase =
    preset.id === "custom"
      ? custom || "style cinématographique réaliste, éclairage naturel, textures photographiques"
      : preset.lockedStylePhrase;
  return {
    ...emptyStyle(),
